...
start_cities_agent1 = [1, 5, 10, 15, 20];
all_pairs = [];
for i = 1:length(start_cities_agent1)
    for j = 1:num_cities
        if start_cities_agent1(i) ~= j
            all_pairs = [all_pairs; start_cities_agent1(i), j];
        end
    end
end
...
filePath = 'Combination_of_1_5_10_15_20.csv';
