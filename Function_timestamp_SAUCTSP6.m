...
writetable(resultsTable, 'Detailed_Results_timestamp.csv', 'WriteMode', 'overwrite');
...
writetable(summaryTable, 'Summary_Results_Timestamp.csv', 'WriteMode', 'overwrite');

fprintf('Detailed results saved to Detailed_Results_timestamp.csv\n');
fprintf('Summary results saved to Summary_Results_Timestamp.csv\n');
